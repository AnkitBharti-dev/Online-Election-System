...
<c:forEach var="item" items="${list}">
   <tr>
    ...
    <td>${item.symbol}</td>
    <td><form action="/OnlineElectionSystem/acceptCandidateApplication" method="post">
    	<input type="hidden" name="application_no" value="${item.application_no}">
    	<input type="hidden" name="voter_id" value="${item.voter_id}">
    	<button>Accept</button>
    </form>
    </td>
    <td><form action="/OnlineElectionSystem/rejectCandidateApplication" method="post">
    	<input type="hidden" value="${item.application_no}" name="application_no">
    	<input type="hidden" name="voter_id" value="${item.voter_id}">
